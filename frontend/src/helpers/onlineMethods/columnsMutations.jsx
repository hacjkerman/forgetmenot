...
export class ColumnMethods {
  addColMutation = async (user, newColumn, colour, currCol, token, columns) => {
  ...
  addColOptions = (newColumn, currCol, colour, columns) => {
  ...
  delColMutation = async (user, column, columns, token) => {
  ...
  updateColOptions = (column, colour, newColumn, columns) => {
  ...
  updateColOrderOptions = (srcIndex, destIndex, columns) => {
