...
export class TodoMethods {
  ...
  addTodoOptions = (newTodo, column, columns) => {
  ...
  delTodoMutation = async (user, column, todo, columns, token) => {
  ...
  delTodoOptions = (column, todo, columns) => {
  ...
  updateTodoOptions = (column, todo, newTodo, colour, columns) => {
  ...
  updateTodoEstimateMutation = async (
    user,
    column,
    todo,
    newEstimate,
  ...
  updateTodoEstimateOptions = (column, todo, newEstimate, columns) => {
    const currCol = columns[column].todos;
    const item = currCol.find((item) => item.id === todo);
